 ...
 * Es en donde se realizan los depositos
 */
...
public class Depositar extends Usuario {
    ...
    // Tenemos un ArrayLisr con los datos de los depositos
    ...
    public static void menuDepo() throws Exception {
        ...
        // Menu que nos permite decidir en que moneda se realizara el deposito
        System.out.println();
